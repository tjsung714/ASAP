...
This Zenodo record provides the input datasets and example outputs required
to run the ASAP burn severity analysis pipeline. The archive includes the
core input data needed by the pipeline, such as wildfire metadata, FIRMS
